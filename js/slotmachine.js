...
var SlotMachine = function(){
	...
	this.items = [
		'img/slots-icons/3xBAR.png',
		'img/slots-icons/BAR.png',
		'img/slots-icons/2xBAR.png',
		'img/slots-icons/7.png',
		'img/slots-icons/Cherry.png'
    ];
...
SlotMachine.prototype.checkResults = function(){
	...
	// Update the balance
	this.balance = this.payTable + parseInt(this.balance);
